class RobotState:
    ...
    def __init__(self, main_debug=False, track_debug=False, game_part_debug=False, utils_debug=False):
        ...
        self.enabled_missions = {
            ...
            4: True,
            5: True,
            6: False,    # Game part που εκτελεί την αποστολή της ζυγαριάς σε δύο προγράμματα
            7: True,
            8: True,
            9: True,
            10: True,   # Υποπρόγραμμα για να μεταφέρει την Ariana
            11: False,  # Νέος τρόπος να εκτελούμε την αποστολή του καραβιού (με ροδάκια)
            12: True    # Θα χτυπήσει 4 φορές το Σιλό αν είναι ενεργό, αλλιώς 3 φορές  
        }
